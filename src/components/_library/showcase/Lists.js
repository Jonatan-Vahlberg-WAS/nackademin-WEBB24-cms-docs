...
const rightAlign = 'tw:!justify-self-end tw:!text-end tw:!text-right'

const DummyListHeaderItem = () => {
  return (
    <ListItem defaultColumns={defaultColumns} queries={dummyQueries} className='tw:!font-bold'>
      <ListItemColumn>
        <p>Name</p>
      </ListItemColumn>
...
const Lists = () => {
  ...
  return (
    <div id='components-lists'>
      <h2 className='tw:!text-xl tw:!font-bold mb-3'>Lists</h2>
      <h3 className='tw:!text-lg tw:!font-bold'>List with Pagination</h3>
      <List
        ...
        renderLoadingItem={({ rowHeight, index }) => <DummyListLoadingItem key={index} rowHeight={rowHeight} />}
        renderFooterItem={() => (
          <DummyFooterItem
            total={getDummyItems(page).reduce((total, item) => total + parseInt(item.total.replace('$', '').replace('.00', '')), 0)}
          />
        )}
        withPagination
        pageSize={10}
        ...
        loading={loading}
      />
      <h3 className='tw:!text-lg tw:!font-bold'>List without Pagination or Card</h3>
      <List
        withCard={false}
        ...
        loading={loading}
      />
      <h3 className='tw:!text-lg tw:!font-bold'>Listitems</h3>
        <ListItem defaultColumns='1fr 1fr 1fr 1fr 1fr' className='tw:!font-bold'>
          {_.times(5, (index) => (
      ...
      <h3 className='tw:!text-lg tw:!font-bold'>Loading Skeleton</h3>
      <ListItem defaultColumns='1fr 1fr 1fr 1fr 1fr' className='tw:!font-bold'>
        {_.times(5, (index) => (
          <ListItemColumn key={index}>
      ...
      <h3 className='tw:!text-lg tw:!font-bold'>Pagination</h3>
