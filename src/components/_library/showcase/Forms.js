...
const Forms = () => {
  ...
  return (
    <div id='components-forms'>
          <h2 className='tw:!text-xl tw:!font-bold mb-3'>Forms</h2>
      <Card>
        <h3 className='tw:!text-lg tw:!font-bold mb-2'>Form (Formik)</h3>
          <Formik
            initialValues={{
              name: '',
              checkbox: false
          ...
          >
            {({ values, setFieldValue, handleSubmit }) => (
              <Form>
                <h4 className='tw:!text-lg tw:!font-bold'>Fields</h4>
                <div className='tw:!flex tw:!flex-wrap tw:!gap-4 tw:!mb-4'>
                  {fieldCombinations.map((combination, index) => (
                    <div key={index}>
                      <Label htmlFor='name' error={combination.error} touched={combination.touched} required={combination.error}>
                        Name (new) ({combination.disabled ? 'disabled' : 'enabled'})
                      </Label>
                      <Field name='name' label='Name' placeholder='Enter your name' {...combination} />
                    </div>
                  ))}
                </div>

                <h4 className='tw:!text-lg tw:!font-bold'>Select Fields (new)</h4>
                <div className='tw:!flex tw:!flex-wrap tw:!gap-4 tw:!mb-4'>
                  {selectFieldCombinations.map((combination, index) => (
                    <div key={index}>
                      <Label htmlFor='choice2' error={combination.error} touched={combination.touched} required={combination.error}>
                        Choice 2 ({combination.disabled ? 'disabled' : 'enabled'})
                      </Label>
                      <SelectField name='choice2' error={combination.error} touched={combination.touched} disabled={combination.disabled}>
                ...
                <h4 className='tw:!text-lg tw:!font-bold'>Checkboxes</h4>
                <div className='tw:!flex tw:!flex-wrap tw:!gap-4 tw:!mb-4'>
                ...
                <h4 className='tw:!text-lg tw:!font-bold'>Files</h4>
                <div className='tw:!flex tw:!flex-wrap tw:!gap-4 tw:!mb-4'>
                  <Files />
                </div>
                </Form>
